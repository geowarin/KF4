...
export(float, 0, 10, 0.01) var sensitivity : float = 3
export(float, 0, 1000, 0.1) var default_velocity : float = 5
export(float, 0, 10, 0.01) var speed_scale : float = 1.17
export(float, 1, 100, 0.1) var boost_speed_multiplier : float = 3.0
